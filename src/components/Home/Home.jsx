    ...
    return (
        <div id="home">
            ...
            <header >
                ...
                <div className="flex">
                    <img src={resultPreviewImg} alt="Result preview" />
                ...
                <div className="flex">
                    ...
                    <img src={subPreviewImg} alt="Subject preview" />

                    <div style={{ height: '32px', width: '100%' }}></div>

                    <img src={distImg} alt="Distribution chart" />
                    <div style={{ display: 'inline-grid', margin: '32px 24px' }}>
                ...
                <hr style={{ width: '10%', margin: '24px auto' }} />
                <div className="flex">
                    <img src={multiRepImg} alt="Multi report preview" />
                    <div style={{ display: 'inline-grid', margin: '32px 24px' }}>
                    ...
                    <div style={{ height: '32px', width: '100%' }}></div>
                    <img src={studentComp} alt="Student comparison chart" />
                    <div style={{ display: 'inline-grid', margin: '32px 24px' }}>
                ...
                <div className="flex">
                    ...
                    <img src={collegeAnalytiycs} alt="College analytics"></img>
                    <div style={{ display: 'inline-grid', margin: '32px 24px' }}>
                    ...
                    <img src={subAnalytiycs} alt="Subject analytics"></img>
                </div>
            </header>
            <footer>
                <span className="title">A project on <img className="rotate" src="https://github.com/prasannathapa/reportcard/raw/master/public/logo192.png" alt="React Logo"></img>
                    and <img alt='nodeJs' src="https://github.com/prasannathapa/reportcard/raw/master/public/nodejs.png"></img> by <a href="https://prasannathapa.in/" target="_blank" rel="noreferrer">Prasanna Thapa</a></span>
            </footer>
        </div>
    )
}
